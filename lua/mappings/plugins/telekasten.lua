...
{'<leader>z', function() require('telekasten').panel() end},
...
{'<leader>zz', function() require('telekasten').follow_link() end},
{'<leader>zT', function() require('telekasten').goto_today() end},
{'<leader>zW', function() require('telekasten').goto_thisweek() end},
...
{'<leader>zc', function() require('telekasten').show_calendar() end},
{'<leader>zC', '<cmd>:CalendarT<CR>'},
{'<leader>zi', function() require('telekasten').paste_img_and_link() end},
{'<leader>zt', function() require('telekasten').toggle_todo() end},
...
{'<leader>zp', function() require('telekasten').preview_img() end},
{'<leader>zm', function() require('telekasten').browse_media() end},
{'<leader>za', function() require('telekasten').show_tags() end},
{'<leader>#',  function() require('telekasten').show_tags() end},
{'<leader>zr', function() require('telekasten').rename_note() end},
...
{'<leader>zU', function() require('telekasten').follow_link({follow_tag='#urgent'}) end}
}

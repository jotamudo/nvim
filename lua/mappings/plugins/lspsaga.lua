return {
  ...
  {"<leader>ga", "<cmd>lua require('lspsaga.codeaction').code_action()<CR>"},
  {"<leader>ga", ":<C-U>lua require('lspsaga.codeaction').range_code_action()<CR>", mode = "v"},
  ...
  {"gl", "<cmd>lua require'lspsaga.diagnostic'.show_line_diagnostics()<CR>"},
  {"gD", "<cmd>lua require'lspsaga.diagnostic'.show_cursor_diagnostics()<CR>"},
  ...
  {"<C-t>", "<C-\\><C-n>:lua require('lspsaga.floaterm').close_float_terminal()<CR>", mode = "t"},
